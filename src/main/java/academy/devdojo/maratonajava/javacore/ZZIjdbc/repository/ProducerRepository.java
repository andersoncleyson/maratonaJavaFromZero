...
public class ProducerRepository {
    public static void save(Producer producer){
        ...
        try(Connection conn = ConnectionFactory.getConnection();
            ...
            log.info("Inserted producer '{}'in the Database, rows affeted '{}'", producer.getName(), rowsAffected);
    ...
    public static void delete(int id){
        ...
        try(Connection conn = ConnectionFactory.getConnection();
            ...
            int rowsAffected = stmt.executeUpdate(sql);
            log.info("Deleted producer '{}'in the Database, rows affeted '{}'", id, rowsAffected);
    ...
    public static void update(Producer producer){
        ...
        try(Connection conn = ConnectionFactory.getConnection();
            ...
            int rowsAffected = stmt.executeUpdate(sql);
            log.info("Updated '{}'in the Database, rows affeted '{}'", producer.getId(), rowsAffected);
    ...
    public static void updatePreparedStatement(Producer producer){
        try(Connection conn = ConnectionFactory.getConnection();
            ...
            log.info("Updated producer '{}', rows affeted '{}'", producer.getId(), rowsAffected);
    ...
    public static List<Producer> findByNameCallableStatement(String name){
        ...
        List<Producer> producers = new ArrayList<>();
        try(Connection conn = ConnectionFactory.getConnection();
            PreparedStatement ps = callableStatementByName(conn, name);
            ResultSet rs = ps.executeQuery()){
    ...
    private static CallableStatement callableStatementByName(Connection conn, String name) throws SQLException {
